...
<div class="buttons">
  <button type="button" class="registerbtn" class="w3-bar-item w3-button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModel">Add Note</button><br>
  <br>
  <br>
  <br>
 <!-- Modal -->
  ...
  <form action="Submitnote" method="post">
        ...
        <div class="modal-body">
<p>Name</p>
<input type="text" placeholder="Note-Name" name="name" class="form-control" width="48" height="48"/>        
<p>StartDate</p>
<input type="date"  name="sd" value="yyyy-MM-dd"  class="form-control" width="48" height="48"/>   
<p>EndDate</p>
<input type="date"  name="ed"  value="yyyy-mm-dd"class="form-control" width="48" height="48"/>
<p>RemainderDate</p>
<input type="date"  name="rd" value="yyyy-mm-dd"  class="form-control" width="48" height="48"/>
<p>Status</p>
<input type="text" placeholder="Status" name="sts" class="form-control" width="48" height="48"/>
<p>Tag</p>
<input type="text" placeholder="Tag" name="tag" class="form-control" width="48" height="48"/>   
<p>Description</p>
<input type="text" placeholder="Description" name="des" class="form-control" width="48" height="48"/>   
   
   
<input type="text" value=<%="'"+request.getParameter("nbname") +"'"%> name="nbname" class="form-control" width="48" height="48" style="display:none"/> 
...
%>
${request.getParameter("nbname")}

<div class=outouter style="display:flex; flex-flow:row">
<div class=side style="width:30%;background-color:red"  >
...
String sql ="SELECT * FROM invnt where uname='"+username +"' AND nbname='"+nbname+"'";
...
<%
sb.add(resultSet.getString("note"));
}
...
<div class=outer style="margin:10px 30px; width:70%">
...
<div class="myDi" style="border:none; background-color:white; width:80% ;margin:10px" >
<div class="myDiv"  >
  <p><%=item %></p>
  </div>
</div>
