...
String sql ="SELECT * FROM notebook where uname='"+username +"'";
...
<div class="myDiv"  >
  <p><%=resultSet.getString("nbname") %></p>
<input type="text" value=<%="'"+resultSet.getString("nbname") +"'"%> name="nbname" class="form-control" width="48" height="48" style="display:none"/>   
